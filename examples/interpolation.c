...
Sint32 main(Sint32 argc, char **argv)
{
    ...
    quad3s[0].transform.scale = (FG_Vec2){ .x = 0.425F, .y = 0.425F };
    ...
    quad3s[1].transform.scale = (FG_Vec2){ .x = 0.425F, .y = 0.425F };
    ...
    quad3s[2].transform.scale = (FG_Vec2){ .x = 0.425F, .y = 0.425F };
    ...
    quad3s[3].transform.scale = (FG_Vec2){ .x = 0.425F, .y = 0.425F };
